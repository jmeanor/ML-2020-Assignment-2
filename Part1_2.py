...
class Part1_2():
        ...
        for i in maxAttempts:
            for j in restarts:
                ...
                for r in range(5):
                    ...
                    state, fitness, curve, time = self._run(
    ...
    def _run(self, algorithm, name='', **kwargs):
        ...
        return best_state, best_fitness, fitness_curve, ellapsed
